...
<head>
  ...
  $(document).ready(function(){
    $("#wholeday").change(function(){
      if($(this).is(":checked")) {
        $("#selectperiod").prop('disabled', true);
      } else {
      ...
      try {
        ...
        while (strtotime($currentdate) <= strtotime($enddate)) {
          ...
          if ((findDayFromDate($currentdate)) == $day) {
            ...
            // else only do it for one given period
            else {
              // if not biweekly, or is biweekly and this is an odd week
              // so that biweekly bookings occur 1st week, 3rd week, ...
              // if book whole day is true
    ...
    <table class="nostyle" id="selectresourcetable">
      ...
      <tr>
        ...
        <td class="nostyle">
          ...
          <input type="checkbox" id="wholeday" name="wholeday">Book whole day?
        </td>
      </tr>
      <tr>
