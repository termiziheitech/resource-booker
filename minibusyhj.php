...
<body>
 ...
 <?php
  ...
  function checkAvailable($conn,$date,$period) {
    $sql = "SELECT BookedByName FROM minibusyhj
  ...
  function createBooking($inputstring,$bookingdesc,$conn) {
    ...
    try {
      ...
      echo "<form method='POST' action='minibusyhj.php'>";
  ...
  <center>
  <h3>Minibus YHJ</h3><br>         
  <form method="POST" action='minibusyhj.php'>
